  ...
  <?php $args = array(
		'tax_query' => array(
			array(
				...
				'field' => 'slug',
				'terms' => 'homepage-primo-piano-titolo-sovrapposto'
			)
		)
	);
  ...
  <?php $args = array(
		'tax_query' => array(
			array(
				'taxonomy' => 'pubblicazione',
				'field' => 'slug',
				'terms' => 'homepage-primo-piano-titolo-sopra'
			)
		)
	);
	$myquery = new WP_Query( $args );
  ...
  <?php $args = array(
		'tax_query' => array(
			array(
				'taxonomy' => 'pubblicazione',
				'field' => 'slug',
				'terms' => 'homepage-quarto-piano-sx'
			)
		)
	);
	$myquery = new WP_Query( $args );
  ...
  <?php $args = array(
		'tax_query' => array(
			array(
				'taxonomy' => 'pubblicazione',
				'field' => 'slug',
				'terms' => 'homepage-quarto-piano-dx'
			)
		)
	);
	$myquery = new WP_Query( $args );
